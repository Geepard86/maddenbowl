...
(function (global) {
  ...
  const IMGFLIP_TEMPLATE_POOLS = {
    // NFL / Madden Bowl: zusätzlich zu den klassischen Imgflip-Vorlagen
    // sind hier bewusst alle vom Admin gewünschten Football-Memes enthalten.
    allTimeHigh: [61544, 155067746, 28251713, 627432492, 627425561, 115398544, 9340393],
    allTimeMargin: [55311130, 97984, 188390779, 203723093, 19833195, 61712394, 554081129],
    tournamentMargin: [188390779, 97984, 101470, 203723093, 19833195, 61712394, 208650053, 627432492],
    winStreak: [61532, 61544, 8072285, 208650053, 155692896, 203723093, 75583105],
    upset: [61579, 155067746, 101470, 203723093, 272113903, 268827476, 627425561, 577208610, 441850935],
    shutout: [55311130, 99683372, 188390779, 203723093, 19833195, 61712394, 554081129, 208650053],
    shootout: [61544, 28251713, 8072285, 155692896, 627432492, 627425561, 115398544],
    finals: [101910402, 135256802, 101470, 272113903, 456538639, 132596627, 627425561, 627432492, 363893507, 127129121, 443004391],
    champion: [61544, 61532, 29617627, 627432492, 627425561, 456538639, 132596627, 489157989],

    // Explizite Story-Pools für die neuen Meme-Anlässe.
    ref: [21900001, 44811986, 169261378, 114267372, 26961037, 632249784, 567189276],
    excuse: [44811986, 21900001, 169261378, 26961037],
    collapse: [203723093, 577208610, 268827476, 75583105, 627425561],
    close: [155692896, 21900001, 627432492, 627425561, 363893507],
    blowout: [19833195, 61712394, 203723093, 208650053, 554081129],
    outOfReach: [554081129, 203723093, 268827476, 272113903],
    tackle: [208650053, 203723093, 75583105, 577208610],
    hype: [404518781, 489157989, 456538639, 441850935, 627425561],
    official: [456538639, 132596627, 627425561, 627432492],
    general: [115398544, 9340393, 627432492, 627425561, 75583105, 363893507, 127129121, 443004391],
  };
